...
public class ActivityConfirmationCode extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        finalContactsList = getIntent().getStringArrayListExtra("val2");
        foundVendors = getIntent().getStringArrayListExtra("val3");
        confirmationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new getRegistrationCode((ActivityConfirmationCode.this)).execute("");
            }
        });
                ...
                h.post(new Runnable() {
                    public void run() {
                        ...
                        if(confirmationCodeText.getText().toString().equals(confirmationCode)) {
                            ...
                            new permUserSignUp(ActivityConfirmationCode.this).execute(surname,firstname,email,phoneNo,userId,
                                    enterPassword);
                        }
                        else{
                            Toast.makeText(ActivityConfirmationCode.this, "Wrong Confirmation Code", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private class permUserSignUp extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(final String... params) {
            ...
            try {
                ...
                Toast.makeText(ActivityConfirmationCode.this,new String("Exception: "+ e.getCause()+ "\n"+ e.getMessage()), Toast.LENGTH_SHORT).show();
            }
            URL url = null;
            HttpURLConnection connection = null;
