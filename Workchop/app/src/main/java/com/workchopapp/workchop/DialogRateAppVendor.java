...
public class DialogRateAppVendor extends DialogFragment {
    ...
    private class sendRating extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            String dataUrl = "http://workchopapp.com/mobile_app/upload_rating_vendor.php";
