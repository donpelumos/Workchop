...
public class AdapterRecent extends ArrayAdapter<ListChats> {
    Context context;
    ...
    public AdapterRecent(final Context context, final int layoutResourceId, final ArrayList<ListChats> data) {
