...
public class DialogWelcome extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_welcome, null);
        ...
        welcomeText.setText("Welcome to Workchop!\n" +
                ...
                "\n" +
                "At Workchop we believe your superb craftsmanship should speak for itself and clients should not have any trouble finding you.\n" +
                "\n" +
                "That's why we created Workchop to connect you with potential customers based on recommendations and references.\n" +
                "You have just joined a growing community of other tradesmen who tell us that our platform is connecting them to more clients than ever before.\n" +
                "Please ensure you have added all your contact and location details accurately.\n" +
                "\n");
