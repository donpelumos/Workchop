...
/**
 * Created by BALE on 06/08/2016.
 */

public class DialogSetNewVendorLocation extends DialogFragment {
    TextView newQuadrant1,newQuadrant2,newQuadrant3,newQuadrant4,newQuadrant5,newQuadrant6,newQuadrant7;
    TextView cantFind;
    DialogSetNewVendorLocation dialogSetNewVendorLocation;
    AlertDialog dialog;
    int quadrantIndex, selectedQuadrant;
    int locationChosen;
    DialogSetNewVendorLocation.ColorSelected mColorSelected;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        locationChosen = 0;
        mColorSelected = (ColorSelected)getTargetFragment();
        ...
        selectLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dismiss();
                /*Intent i = new Intent()
                        .putExtra("index", selectedQuadrant);
